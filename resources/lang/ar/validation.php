...
return [
    ...
    "date_equals" => "يجب أن تكون السمة تاريخًا يساوي: التاريخ.",
    ...
    "dimensions" => "السمة لها أبعاد الصورة غير صالحة.",
    ...
    "gt" => [
        ...
        "file" => "يجب أن تكون السمة أكبر من: قيمة كيلوغرام.",
    ...
    "lte" => [
        ...
        "file" => "يجب أن تكون السمة أقل من أو متساوية: قيمة كيلوبايت.",
    ...
    "unique" => "السمة: تم أخذ السمة بالفعل.",
